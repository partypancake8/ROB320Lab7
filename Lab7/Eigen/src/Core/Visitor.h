...
struct visitor_impl<Visitor, Derived, 0> {
  EIGEN_DEVICE_FUNC
  static inline void run(const Derived &/*mat*/, Visitor& /*1_visitor*/)
  {}
};
...
/** Applies the 1_visitor \a 1_visitor to the whole coefficients of the matrix or vector.
  *
  * The template parameter \a Visitor is the type of the 1_visitor and provides the following interface:
  * \code
  * struct MyVisitor {
  ...
  *
  * \note if the matrix is empty, then the 1_visitor is left unchanged.
  *
...
/** \returns the maximum of all coefficients of *this and puts in *index its location.
  ...
  * \warning the matrix must be not empty, otherwise an assertion is triggered.
  *
  * \sa DenseBase::maxCoeff(IndexType*,IndexType*), DenseBase::minCoeff(IndexType*,IndexType*), DenseBase::1_visitor(), DenseBase::maxCoeff()
  */
template<typename Derived>
template<int NaNPropagation, typename IndexType>
EIGEN_DEVICE_FUNC
